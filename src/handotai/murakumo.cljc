...
(defn collection
  [name]
  (str "com.etzhayyim.handotai." name))

(def cell-specs {
  :listarticles {:legacy-cell "com-etzhayyim-apps-handotai-listArticles"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "listarticles")]
     :required-gates common-gates
     :trigger "manifest cell listarticles"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :get {:legacy-cell "com-etzhayyim-apps-handotai-coverage-get"
     :phase :event
     :murakumo-node "reuben"
  ...
  :article {:legacy-cell "com-etzhayyim-apps-handotai-article"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :source {:legacy-cell "com-etzhayyim-apps-handotai-source"
     :phase :event
     :murakumo-node "reuben"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :entity {:legacy-cell "com-etzhayyim-apps-handotai-entity"
     :phase :event
     :murakumo-node "reuben"
